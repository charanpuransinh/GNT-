...
router.get('/attendance/employee/:employeeId', attendance.getByEmployee.bind(attendance));
router.get('/attendance/monthly-report', attendance.getMonthlyReport.bind(attendance));
router.post('/attendance/bulk', attendance.bulkUpload.bind(attendance));

router.post('/leaves', leave.apply.bind(leave));
router.get('/leaves/pending', leave.getPendingApprovals.bind(leave));
router.get('/leaves/employee/:employeeId', leave.getByEmployee.bind(leave));
router.get('/leaves/balance/:employeeId', leave.getBalance.bind(leave));
