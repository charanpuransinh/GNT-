...
// WIRING FIX (2026-08-28): removed `export { ReportQueryBuilder } from './services/report.internal'` —
// that file's own header says "INTERNAL ONLY — Not exposed publicly", but index.ts was exporting it
// as part of M17's PUBLIC contract anyway. Other modules should never import report.internal directly.
