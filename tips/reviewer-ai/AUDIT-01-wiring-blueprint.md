...
## F5 — ~~21~~ **58** prisma models कोड इस्तेमाल करता है, canonical schema में हैं ही नहीं

> **🔴 सुधार (2026-09-02, AUDIT-02 के दौरान पकड़ा):** नीचे लिखी **21 की गिनती ग़लत थी — असली 58 है।**
> मेरा scan सिर्फ़ `prisma.snake_case` वाले calls पढ़ता था, और M12–M20 का कोड
> `prisma.notificationMaster` / `prisma.auditLog` जैसे **camelCase** नाम बुलाता है — वो सब छूट गए।
> सही गिनती: कोड **96** models बुलाता है, schema में **45** हैं, **58 गायब**।
> पूरी सूची और module-वार बँटवारा `AUDIT-02-team-d-m16-m20.md` में है।
> **सबक:** गिनती का scan लिखते वक़्त पहले यह देखूँ कि repo में एक ही चीज़ कितनी शैलियों में लिखी जाती है।
