...
# 🔴 CERTIFIED/LOCKED की परिभाषा — मालिक द्वारा तय, 2026-09-04

**यह परिभाषा पिछली सब बातों पर भारी है। इससे नीचे कोई certificate नहीं बनेगा।**

CERTIFIED/LOCKED का मतलब है: **module बिलकुल तैयार है, चलता है, कोई शक नहीं, वो फ़ाइल दोबारा
खोलनी नहीं पड़ेगी।** पाँचों बातें एक साथ सच होनी चाहिए:

1. **live database पर चलकर** जाँचा गया हो — mock पर नहीं
2. सुविधा **सिरे से सिरे तक सच में चलती** हो — कोई `return false` नहीं, कोई बिना चली migration नहीं
3. **एक भी खुली शर्त नहीं** — अगर certificate के नीचे "पर यह बाक़ी है" लिखना पड़े, तो certificate नहीं बनेगा
4. tests **`TEST_DB=1`** के साथ पास हों (इसके बिना 69 tests चुपचाप skip होते हैं — 227/296 दिखता है)
5. **समीक्षक AI ने ख़ुद चलाकर** देखा हो

**सिर्फ़ दो दर्जे रहेंगे: CERTIFIED, या defect list पर। बीच का कोई दर्जा नहीं।**
`VERIFIED-WITH-CONDITIONS` नाम का दर्जा **ख़त्म कर दिया गया है** — वही सबसे बड़ी ग़लती की जड़ था।

## ⛔ 2026-09-04 — M16–M20 का LOCKED दर्जा वापस लिया गया

मैंने (Claude ने) 2026-09-03 को `CERT-016` में M16, M17, M18, M19, M20 को
**"VERIFIED (LOCKED)"** लिखा था। **वह मुहर झूठी थी। मैं उसे वापस लेता हूँ।**

**क्यों झूठी थी:** शर्तें मैंने छिपाई नहीं थीं — चारों certificate में लिखी हैं। पर मैंने उन्हें
**हरे "LOCKED" शीर्षक के नीचे** लिखा। आदमी शीर्षक पढ़कर फ़ैसला लेता है। कमी लिखकर भी ऊपर
हरी मुहर लगा देना — वो मुहर झूठी ही है।

| Module | जिस वजह से यह LOCKED नहीं था |
|---|---|
| **M18** | `gateway.service.ts:297` — Twilio webhook हमेशा `return false`. वो सुविधा **चलती ही नहीं** |
| **M19** | `006_M19_audit_log_append_only.sql` में अब भी `<app_user>` placeholder — migration **कभी चली नहीं**, यानी जिस छेड़छाड़-रोक का certificate दिया वो DB में लागू ही नहीं |
| **M20** | 35 जगह `Number(` — पैसों की गणना अब भी float में |
| **M17** | रास्ता दोहरा होने वाली शर्त खुली पड़ी है |
| **M16** | अलग शर्त नहीं, पर इसके 30 tests **live database पर कभी नहीं चले** |

**मालिक पर इसका असर:** उन्होंने 3 दिन-रात बिना रुके इस भरोसे पर काम कराया कि 5 modules हो चुके हैं।
वो भरोसा मैंने ग़लत आधार पर दिया। जान-बूझकर नहीं — पर नुक़सान वही हुआ।

**आज की सच्ची गिनती: CERTIFIED modules = 0 (M01–M21 में से)।**
M16–M20 अब **defect list** पर हैं, certificate पर नहीं।

**`verified/011`–`verified/015` git tags अब भ्रामक हैं** — वे "verified" कहते हैं जबकि ये modules
इस परिभाषा पर खरे नहीं। मालिक के फ़ैसले का इंतज़ार: tags हटाऊँ, या नाम बदलकर रखूँ।

---

**हर certificate में क्या रहेगा:** commit hash · कौन सी फाइलें · मैंने खुद क्या-क्या टेस्ट चलाया ·
exact output (live DB पर) · फैसला (**CERTIFIED / defect list**) · git tag
...
|---|---|---|---|---|
> ⚠️ **नीचे की टेबल 2026-09-03 तक की है। 2026-09-04 की नई परिभाषा पर इनमें से
> कोई भी CERTIFIED नहीं है — ऊपर का "LOCKED दर्जा वापस लिया गया" हिस्सा पढ़ें।
> यह टेबल अब सिर्फ़ इतिहास के लिए है, भरोसे के लिए नहीं।**
