...
import { type Payment, type ListResponse, type PaymentMethod } from '../types/payment.types';
...
export const PaymentEntryPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // पहले यह free-text था ("जैसे UPI/NEFT/नकद") — backend paymentMethodId को असली
    // payment_method row की id मानकर ढूँढता है, टाइप किया हुआ text नहीं। हर submit
    // "Invalid payment method" पर फेल होता। अब असली methods list से dropdown।
